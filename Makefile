...
caltime.a:\
cc-slib caltime.sld calt_fmt.o calt_loc.o calt_scan.o calt_utc.o 
...
obj_clean: 
	...
	calt_utc.o caltime.a chrono-conf chrono-conf.o ctxt/bindir.c \
	ctxt/bindir.o ctxt/ctxt.a ctxt/dlibdir.c ctxt/dlibdir.o \
	ctxt/incdir.c ctxt/incdir.o ctxt/leapsec.c ctxt/leapsec.o \
	...
	instchk instchk.o insthier.o leaps_add.o leaps_data.o 
	rm -f leaps_free.o leaps_init.o leaps_read.o leaps_sub.o leapsecs \
	leapsecs.a leapsecs.o tai.a tai64 tai64.o tai64n tai64n.o tai64na \
	tai64na.o tai_add.o tai_approx.o tai_diff.o tai_get.o tai_label.o \
	tai_now.o tai_pack.o tai_set.o tai_sub.o tai_unix.o tai_unpack.o \
